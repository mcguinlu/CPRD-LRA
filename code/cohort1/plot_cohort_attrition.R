...
#Define main dataset
main <- read.csv("./data/additional/cohort_attrition.csv")
...
main[2,3] <- paste0("Patients prescribed an lipid regulating agent of interest\n(n=", main[2,2],")")
...
main[14,3] <- paste0("Patients with an index date prior to 1/1/1996\n(n=", main[14,2],")")

main[15,3] <- paste0("Patients not prescribed a lipid regulating drug of interest\n(n=", main[15,2],")")
...
main[27,3] <- paste0("Patients with an index date after 1/1/1996\n(n=", main[27,2],")")
...
html_print(add_mathjax(graph)) %>%
  webshot(file = "output/figures/cohort_attrition.png", delay = 1,
