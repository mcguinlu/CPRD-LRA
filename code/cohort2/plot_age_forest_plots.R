...
g3<- ggplot(cohort2results.age, aes(y = HR, x = age, colour = grouping, label = label)) + 
  geom_linerange(aes(ymin = ci_lower, ymax = ci_upper), size = .8) +
  geom_point(size = 2) + 
...
ggsave("output/fp_cox_alldem_age.jpeg",g4,height =10, width = 15, unit = "cm", dpi = 600, scale = 1.75)
