...
knitr::opts_chunk$set(echo = FALSE, eval = FALSE) # Remove to knit with plots/data
options(scipen = 999)
```
...
We performed a prospective cohort study using data from the CPRD, a large UK primary healthcare database. The CPRD 
...
percentage.statins <- 
  paste0(round(as.numeric(cohort2table1[1,3])/sum(cohort2table1[1:9])*100, 2), "%")
